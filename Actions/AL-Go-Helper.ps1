...
$defaultBcContainerHelperVersion = "https://github.com/mazhelez/navcontainerhelper/archive/refs/heads/fix-assemblyprobingpaths.zip" # Must be double quotes. Will be replaced by BcContainerHelperVersion if necessary in the deploy step - ex. "https://github.com/organization/navcontainerhelper/archive/refs/heads/branch.zip"
